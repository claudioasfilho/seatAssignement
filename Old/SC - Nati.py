...
for i in range(0,totalNumberStudents):
	...
	if (frontCnt>0) and ((tCnt == 0) or (tCnt == 1)):
		...
		if (behavior3Cnt>0)  and ( (((tCnt == 0) or (tCnt == 1) or (tCnt == 2)) and (behFlag != 3) and (badFlag == 'good') ) or (behFlag == 0)):
			...
			if(behavior2Cnt>0)  and ( (((tCnt == 0) or (tCnt == 1)) and ((behFlag != 3) and (behFlag != 2) and (badFlag == 'good')) )):
